export default {
  ...
  'menu.dashboard.information': 'Sports Information Sharing',
  'menu.information.base': 'BASE SETTING',
  'menu.information.advertise': 'ADVERTISE SETTING',
  'menu.information.float': 'FLOAT SETTING',
};
